...
chrome_options.add_argument("--headless") #run chrome headless (no window visible)
...
# switch to scraping untapped site
# beautifulsoup will work because site is simpler
